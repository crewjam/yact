...
//
// This is a modified version that is super-duper trivial:
//  - On Windows, all messages go to OutputDebugString and the console
//  - On Linux, all messages to to syslog and the console
...
// The default handler terminates the process, however clients can use this
